...
import 'package:flutter_bank_app/constants.dart';

class ProfileSection extends StatelessWidget {
  const ProfileSection({Key? key,required this.verticalPos}) : super(key: key);
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Opacity(
                  opacity: 1.0,//(0.0, 1.0, (verticalPos??0.0)/MediaQuery.of(context).size.height),
  ...
  Widget buildUserAvatar(String image, String name) {
    return Column(
      children: [
        CircleAvatar(
          radius: 30,
